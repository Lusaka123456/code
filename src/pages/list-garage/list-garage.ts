...
/**
 * Generated class for the ListGaragePage page.
 *
...
@Component({
  selector: 'page-list-garage',
  templateUrl: 'list-garage.html',
})
export class ListGaragePage {
  form: FormGroup;
  ...
  save() {
    if (this.form.valid) {
      ...
      this.http.post(this.global.url + 'mobListGarage', this.form.value)
        .toPromise()
